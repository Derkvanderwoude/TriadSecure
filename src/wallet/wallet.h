...
public:
    ...
    bool SelectCoinsByDenominations(int nDenom, CAmount nValueMin, CAmount nValueMax, std::vector<CTxIn>& vecTxInRet, std::vector<COutput>& vCoinsRet, CAmount& nValueRet, int nSpySendRoundsMin, int nSpySendRoundsMax);
    bool GetCollateralTxIn(CTxIn& txinRet, CAmount& nValueRet) const;
    bool SelectCoinsDark(CAmount nValueMin, CAmount nValueMax, std::vector<CTxIn>& vecTxInRet, CAmount& nValueRet, int nSpySendRoundsMin, int nSpySendRoundsMax) const;
    ...
    /// Get 1000ARC output and keys which can be used for the Masternode
    ...
    int GetRealInputSpySendRounds(CTxIn txin, int nRounds) const;
    // respect current settings
    int GetInputSpySendRounds(CTxIn txin) const;
    ...
    bool GetEvolutionSystemCollateralTX(CTransaction& tx, uint256 hash, CAmount amount, bool fUseInstantSend);
    bool GetEvolutionSystemCollateralTX(CWalletTx& tx, uint256 hash, CAmount amount, bool fUseInstantSend);
