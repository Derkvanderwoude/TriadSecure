    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Triad Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Triad address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and triad: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Triad Core"), this);
    aboutAction->setStatusTip(tr("Show information about Triad Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Triad Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Triad addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Triad addresses"));
    ...
    openAction->setStatusTip(tr("Open a triad: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Triad Core help message to get a list with possible Triad Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Triad Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Triad network", "", count));
}
...
{
    QString strTitle = tr("Triad Core"); // default title
