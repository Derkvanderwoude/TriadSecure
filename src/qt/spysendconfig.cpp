...
void SpySendConfig::clickBasic()
{
    ...
    QMessageBox::information(this, tr("SpySend Configuration"),
        tr(
            "SpySend was successfully set to basic (%1 and 2 rounds). You can change this at any time by opening Triad's configuration screen."
        ).arg(strAmount)
    );
...
void SpySendConfig::clickHigh()
{
    ...
    QMessageBox::information(this, tr("SpySend Configuration"),
        tr(
            "SpySend was successfully set to high (%1 and 8 rounds). You can change this at any time by opening Triad's configuration screen."
        ).arg(strAmount)
    );
...
void SpySendConfig::clickMax()
{
    ...
    QMessageBox::information(this, tr("SpySend Configuration"),
        tr(
            "SpySend was successfully set to maximum (%1 and 16 rounds). You can change this at any time by opening Triad's configuration screen."
        ).arg(strAmount)
    );
