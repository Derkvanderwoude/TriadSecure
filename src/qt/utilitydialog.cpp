    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Triad Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Triad Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  triad-qt [" + tr("command-line options") + "]                     " + "\n";
        ...
        setWindowTitle(tr("SpySend information"));
...
All the Triad in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://TriadCore.atlassian.net/wiki/display/DOC/SpySend\">https://TriadCore.atlassian.net/wiki/display/DOC/SpySend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Triad Core is shutting down...") + "<br /><br />" +
