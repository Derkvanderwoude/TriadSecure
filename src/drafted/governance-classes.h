 ...
 *
 *   // network
 *   CArcticNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.triad.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CArcticNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ArcticNetwork
// //   -- signature requirements : Key1(User)
// class CArcticNetworkVariable : public CGovernanceObject
// {
// private:
