...
Only requiring some minor changes is triad.cpp.
...
Changes to triad.cpp
----------------------
triad.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
